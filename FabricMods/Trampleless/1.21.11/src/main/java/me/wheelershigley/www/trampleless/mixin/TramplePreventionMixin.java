...
public abstract class TramplePreventionMixin extends Block {
    ...
    public void onLandedUpon(World world, BlockState state, BlockPos pos, Entity entity, double fallDistance) {
        ...
        boolean farmlandTrampling =         gameRules.getValue(FARMLAND_TRAMPLING);
        boolean featherFallingTrampling =   gameRules.getValue(FEATHER_FALLING_TRAMPLING);
        boolean doMobGriefing =             gameRules.getValue(GameRules.DO_MOB_GRIEFING);
