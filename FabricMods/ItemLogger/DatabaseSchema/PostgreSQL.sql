...
CREATE UNIQUE INDEX ON "items" ("namespace", "name");

CREATE UNIQUE INDEX ON "components" ("namespace", "name");

CREATE UNIQUE INDEX ON "components" ("type");

CREATE UNIQUE INDEX ON "items_components" ("item", "component", "order");
