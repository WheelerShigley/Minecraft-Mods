package me.wheelershigley.www.tree_in_a_forest.blacklist;

import me.wheelershigley.www.tree_in_a_forest.helpers.ConversionsHelper;
...
import static me.wheelershigley.www.tree_in_a_forest.TreeInAForest.LOGGER;
import static me.wheelershigley.www.tree_in_a_forest.TreeInAForest.MOD_ID;
import static me.wheelershigley.www.tree_in_a_forest.helpers.ConversionsHelper.*;

public class Blacklist {
    public static ArrayList<NameAndId> configEntryBlacklist = new ArrayList<>();
    ...
    private static boolean writeFile() {
        try {
            ...
            for(NameAndId user : configEntryBlacklist) {
                playerListBuilder
                    .append( user.id().toString().replace("-", "") )
                    .append("\r\n")
                ;
            }
    ...
    public static void initializeBlackList(boolean isOnlineMode) {
        ...
        String currentLine;
        NameAndId currentEntry;
        while( reader.hasNext() ) {
            //TODO: convert to async
            currentLine = reader.next();
            currentEntry = ConversionsHelper.getPlayerConfigEntryFromUUID(
            ...
            if(
                ...
                if(currentEntry != null) {
                    Blacklist.configEntryBlacklist.add(currentEntry);
                } else {
                    //TODO: logging
                }
            } else {
    ...
    public static String[] getBlacklistedNames() {
        ...
        String currentName;
        for(NameAndId entry : Blacklist.configEntryBlacklist) {
    ...
    public static boolean blacklistUser(NameAndId entry) {
    ...
    public static boolean unblacklistUser(NameAndId entry) {
