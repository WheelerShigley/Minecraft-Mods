...
import static me.wheelershigley.www.tree_in_a_forest.TreeInAForest.*;

public class ConversionsHelper {
    public static NameAndId getProfileFromPlayerName(@Nullable String name) {
        if(
            name == null
        ...
        Optional<NameAndId> potentialPlayerConfigEntry = nameToIdCache.get(name);
    ...
    public static NameAndId getPlayerConfigEntryFromUUID(UUID uuid, boolean isOnlineMode) {
        if(uuid == null) {
            return null;
        }
