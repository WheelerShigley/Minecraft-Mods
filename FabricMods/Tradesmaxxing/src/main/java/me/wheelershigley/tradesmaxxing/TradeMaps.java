...
public class TradeMaps {
    public static final ImmutableMap<Integer, TradeOffers.Factory[] > FARMERTRADES = ImmutableMap.of(
        1,
    ...
    public static final ImmutableMap<Integer, TradeOffers.Factory[] > FISHERMANTRADES = ImmutableMap.of(
        1,
        new TradeOffers.Factory[]{
        ...
        new TradeOffers.Factory[]{
            ...
            new TradeOffers.BuyItemFactory(Items.OAK_BOAT, 1, 12, 30)
        }
    );

    public static final ImmutableMap<Integer, TradeOffers.Factory[] > SHEPHERDTRADES = ImmutableMap.of(
        1,
        new TradeOffers.Factory[]{
    ...
    public static final ImmutableMap<Integer, TradeOffers.Factory[] > FLETCHERTRADES = ImmutableMap.of(
        1,
        new TradeOffers.Factory[]{
    ...
    public static final ImmutableMap<Integer, TradeOffers.Factory[] > LIBRARIANTRADES = ImmutableMap.of(
        1,
        new TradeOffers.Factory[]{
    ...
    public static final ImmutableMap<Integer, TradeOffers.Factory[] > CARTOGRAPHERTRADES = ImmutableMap.of(
        1,
        new TradeOffers.Factory[]{
            new TradeOffers.BuyItemFactory(Items.PAPER, 24, 16, 2),
    ...
    public static final ImmutableMap<Integer, TradeOffers.Factory[] > CLERICTRADES = ImmutableMap.of(
        1,
        new TradeOffers.Factory[]{
    ...
    public static final ImmutableMap<Integer, TradeOffers.Factory[] > ARMORORTRADES = ImmutableMap.of(
        1,
        new TradeOffers.Factory[]{
    ...
    public static final ImmutableMap<Integer, TradeOffers.Factory[] > WEAPONSMITHTRADES = ImmutableMap.of(
        1,
        new TradeOffers.Factory[]{
            new TradeOffers.BuyItemFactory(Items.COAL, 15, 16, 2),
            new TradeOffers.SellItemFactory(
    ...
    public static final ImmutableMap<Integer, TradeOffers.Factory[] > TOOLSMITHTRADES = ImmutableMap.of(
        1,
        new TradeOffers.Factory[]{
            new TradeOffers.BuyItemFactory(Items.COAL, 15, 16, 2),
            new TradeOffers.SellItemFactory(
    ...
    public static final ImmutableMap<Integer, TradeOffers.Factory[] > BUTCHERTRADES = ImmutableMap.of(
        1,
        new TradeOffers.Factory[]{
    ...
    public static final ImmutableMap<Integer, TradeOffers.Factory[] > LEATHERWORKERTRADES = ImmutableMap.of(1,
        new TradeOffers.Factory[]{
    ...
    public static final ImmutableMap<Integer, TradeOffers.Factory[] > MASONTRADES = ImmutableMap.of(
        1,
        new TradeOffers.Factory[]{
