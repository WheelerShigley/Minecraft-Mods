...
import me.wheelershigley.www.charged.Charged;
...
public class GameRuleRegistrar {
    ...
    public static void registerGameRules() {
        ENABLE_PLAYER_HEAD_DROP = GameRuleBuilder
            ...
            .buildAndRegister(
                Identifier.fromNamespaceAndPath(Charged.MOD_ID, "player_head_drop")
            )
        ;
        ENABLE_PLAYER_HEAD_DROP_TEXTURES = GameRuleBuilder
            ...
            .category(GameRuleCategory.PLAYER)
            .buildAndRegister(
                Identifier.fromNamespaceAndPath(Charged.MOD_ID, "player_head_drop_textures")
            )
        ;
        ENABLE_PLAYER_HEAD_TEXTURE_WASHING = GameRuleBuilder
            ...
            .category(GameRuleCategory.PLAYER)
            .buildAndRegister(
                Identifier.fromNamespaceAndPath(Charged.MOD_ID, "player_head_texture_washing")
            )
        ;
        MAXIMUM_HEAD_DROP_COUNT = GameRuleBuilder
            ...
            .category(GameRuleCategory.PLAYER)
            .buildAndRegister(
                Identifier.fromNamespaceAndPath(Charged.MOD_ID, "maximum_head_drop_count")
            )
        ;
